        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                if self.ant.can_contain(insect):
                    ...
                    raise AssertionError('Two non-container ants in {0}'.format(self))
                # END Problem 9
        else:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
        	...
        	for b in attack_bees:
        		b.reduce_armor(self.damage)
        	self.place.remove_insect(self)    # must attack bees before being removed
        # END Problem 5
...
class HungryAnt(Ant):
    ...
    def __init__(self):
        # BEGIN Problem 6
        super().__init__()  		# initialize armor as Ant class
        self.digesting = 0
        # END Problem 6
