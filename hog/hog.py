...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for i in range(num_rolls):
        dc = dice()
        if dc == 1:
            flag = True    # if meets 1 in a roll, record this information
        sumn += dc
    if flag:
        return 1
    return sumn
...
def free_bacon(score):
    ...
    if score < 10:
        ...
        dight2 = score // 10
        if dight1 > dight2:
            return dight1 - dight2 + 2
        return dight2 - dight1 + 2
    # END PROBLEM 2
...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    # both scores have to be larger than 1
    return score0>1 and score1>1 and (score1%score0==0 or score0%score1==0)
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    strat = [strategy0, strategy1]
    score = [score0, score1]

    while score[0]<goal and score[1]<goal:
        num = strat[player](score[player], score[other(player)])
        score[player] += take_turn(num, score[other(player)], dice)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    best_avg = 0
    for i in range(1, 11):
        cur_avg = make_averaged(roll_dice, num_samples)(i, dice)
        if cur_avg > best_avg:
            best_id, best_avg = i, cur_avg
    return best_id
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if is_swap(score, opponent_score) or bacon_strategy(score, opponent_score, margin, num_rolls)==0:
        return 0
    return num_rolls
    # END PROBLEM 11
...
if __name__ == '__main__':
    ...
    s0, s1 = play(strat0, strat1, score0=40, score1=92, dice=make_test_dice(3))
    print(s0, s1)
'''
